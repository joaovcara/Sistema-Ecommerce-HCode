							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
											<label class="" for="billing_address_1">Numero <abbr title="required" class="required">*</abbr>
											</label>
											<input type="text" value="" placeholder="Numero" id="billing_address_1" name="desnumber" class="input-text ">
										</p>
											...
											<table class="shop_table">
												...
												<tfoot>
													<tr class="cart-subtotal">
														<th>Subtotal</th>
														<td><span class="amount">R$<?php echo formatPrice($cart["subtotal"]); ?></span>
														</td>
													</tr>
													<tr class="shipping">
														<th>Frete</th>
