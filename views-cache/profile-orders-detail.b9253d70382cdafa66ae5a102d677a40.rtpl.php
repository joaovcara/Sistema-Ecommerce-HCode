                    ...
                    <table class="shop_table">
                        ...
                        <tfoot>
                            <tr class="cart-subtotal">
                                <th>Subtotal</th>
                                <td><span class="amount">R$<?php echo htmlspecialchars( $cart["subtotal"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
                                </td>
                            </tr>
                            <tr class="shipping">
                                <th>Frete</th>
                            ...
                            <tr class="order-total">
                                ...
                                <td><strong><span class="amount">R$<?php echo htmlspecialchars( $cart["total"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span></strong> </td>
                            </tr>
                        </tfoot>
                    </table>
                    <div id="payment">
