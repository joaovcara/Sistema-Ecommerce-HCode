...
$app->get("/boleto/:idorder", function($idorder){
	...
	$valor_cobrado = formatPrice($order->gettotal()); // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
	...
	$dadosboleto["endereco2"] = $order->descity() . " " . $order->getdesstate() . " "  . $order->getdescountry() .  " CEP: " . $order->getdeszipcode();
